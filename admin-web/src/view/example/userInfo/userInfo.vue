  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column type="selection" width="55" />
            ...
            <el-table-column align="left" label="登录名称" prop="login_name" width="120" />

            <el-table-column align="left" label="密码" prop="password" width="120" />

            <el-table-column align="left" label="createdAt字段" prop="created_at" width="180">
   <template #default="scope">{{ formatDate(scope.row.created_at) }}</template>
</el-table-column>
            <el-table-column align="left" label="updatedAt字段" prop="updated_at" width="180">
   <template #default="scope">{{ formatDate(scope.row.updated_at) }}</template>
</el-table-column>
            <el-table-column align="left" label="salt字段" prop="salt" width="120" />

            <el-table-column align="left" label="最后登录时间" prop="last_login_time" width="180">
   <template #default="scope">{{ formatDate(scope.row.last_login_time) }}</template>
</el-table-column>
            <el-table-column align="left" label="手动验证码" prop="mobile_authcode" width="120" />
    ...
    {{ detailForm.updated_at }}
                    ...
                    <el-descriptions-item label="salt字段">
    {{ detailForm.salt }}
</el-descriptions-item>
                    <el-descriptions-item label="最后登录时间">
    {{ detailForm.last_login_time }}
</el-descriptions-item>
                    <el-descriptions-item label="手动验证码">
    {{ detailForm.mobile_authcode }}
</el-descriptions-item>
