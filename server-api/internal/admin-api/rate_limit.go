...
import (
	...
	rateLimitBiz "megin/internal/module/rate_limit/biz"
...
func (h *RateLimitRule) PageList(ctx *api.Context, req *rateLimitDto.RateLimitRulePageReq) (*api.Result[rateLimitDto.PageResult[rateLimitDto.RateLimitRule]], error) {
