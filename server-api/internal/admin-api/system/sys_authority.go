...
// @Summary 创建角色
// @Description 创建系统角色
func (this *SysAuthority) CreateAuthority(ctx *api.Context, req *systemDto.CreateAuthorityReq) (*api.Result[Success], error) {
...
func (this *SysAuthority) CopyAuthority(ctx *api.Context, req *systemDto.CopyAuthorityReq) (*api.Result[Success], error) {
...
// @Summary 更新角色
// @Description 更新角色信息
func (this *SysAuthority) UpdateAuthority(ctx *api.Context, req *systemDto.UpdateAuthorityReq) (*api.Result[Success], error) {
...
// @Summary 删除角色
// @Description 删除系统角色
func (this *SysAuthority) DeleteAuthority(ctx *api.Context, req *systemDto.DeleteAuthorityReq) (*api.Result[Success], error) {
...
func (this *SysAuthority) SetDataAuthority(ctx *api.Context, req *systemModel.SysAuthority) (*api.Result[Success], error) {
...
func (this *SysAuthority) SetMenuAuthority(ctx *api.Context, req *systemDto.SetMenuAuthorityReq) (*api.Result[Success], error) {
...
// @Summary 设置角色用户
// @Description 为角色设置用户
func (this *SysAuthority) SetRoleUsers(ctx *api.Context, req *systemDto.SetRoleUsersReq) (*api.Result[Success], error) {
