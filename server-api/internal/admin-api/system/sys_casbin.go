...
func (this *SysCasbin) UpdateCasbin(ctx *api.Context, req *systemDto.CasbinCreateReq) (*api.Result[Success], error) {
...
func (this *SysCasbin) ClearCasbin(ctx *api.Context, req *systemDto.AuthorityIdReq) (*api.Result[Success], error) {
...
func (this *SysCasbin) FreshCasbin(ctx *api.Context, req *systemDto.AuthorityIdReq) (*api.Result[Success], error) {
...
func (this *SysCasbin) UpdateCasbinApi(ctx *api.Context, req *CasbinApiUpdateReq) (*api.Result[Success], error) {
