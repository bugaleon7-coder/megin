...
func (this *Article) Create(ctx *api.Context, req *dto.CreateArticle) (*api.Result[api.Success], error) {
...
// Update @Summary 更新文章
// @Description 更新已有文章的信息，并返回更新后的文章对象
func (this *Article) Update(ctx *api.Context, req *dto.UpdateArticle) (*api.Result[dto.Article], error) {
	updatedArticle, err := service.NewArticle(ctx).Update(req)
	if err != nil {
		return nil, err
	}
	return api.ResultData(updatedArticle)
}

// Delete @Summary 删除文章
// @Description 根据文章ID删除文章
func (this *Article) Delete(ctx *api.Context, req *dto.Article) (*api.Result[api.Success], error) {
