...
func (h *User) Register(ctx *api.Context, req *dto.RegisterReq) (*api.Result[dto.LoginUser], error) {
...
func (h *User) Info(ctx *api.Context, req *dto.EmptyReq) (*api.Result[dto.UserInfoResponse], error) {
	if ctx.UserInfo == nil {
...
func (h *User) Login(ctx *api.Context, req *dto.LoginReq) (*api.Result[dto.LoginResponse], error) {
